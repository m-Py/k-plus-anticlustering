...
Here, $w_t$ is the weight associated with the $t$'th moment and $\overline{\mathbf{X}}^{(k)}_{T \times P} = \{\overline{x}_{tj}^{(k)}\}_{T \times P}$ is a centroid matrix containing the mean values for all k-plus variables in the $k$'th group, i.e.
