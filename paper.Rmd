...
Table 3 illustrates the degree of overlap between anticlustering partitions that were identified in Simulation 2. Overall, it is shown that there was hardly any similarity between anticlustering partitions according to the different criteria. The average ARI was almost 0 in all cases---indicating no similarity of partitions whatsoever. This constitutes an interesting and novel result, illustrating that high between-group similarity can be achieved via very different partitionings.
