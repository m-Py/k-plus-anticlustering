...
- Here, we provide researchers with a practical introduction to their method and also present several extensions
...
- Technical introduction to our extensions
  * Optimal dispersion method: Basic algorithm + graph coloring ILP
    * How to maintain optimal dispersion while the BILS runs?
