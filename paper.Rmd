...
$SSE_{\mathrm{VAR}}$, respectively (Figure 1). Figure 2 illustrates 
similarity in means plotted against similarity in variances across all 
partitions. Ideally, a partition is chosen that minimizes the 
difference with regard to means and variances (see the triangular 
