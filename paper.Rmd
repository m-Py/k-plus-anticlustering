...
Here, $w_t$ is the weight associated with the $t$'th moment and $\overline{x}_{tj} ^{(k)}$ is the $k$'th group mean on the $j$'th $t$-moment variable. Maximizing $\mathit{SSE_{kplusGeneralized}}$ can be used to minimize differences with regard to the first $T$ distribution moments between $K$ groups. 
